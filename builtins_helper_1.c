...
/**
 * help_exit - information about the shell's built-in
 * exit command is displayed.
 */
void help_exit(void)
{
...
/**
 * help_help - information about the shellby
 * built-in command "help" is displayed.
 */
void help_help(void)
{
...
/**
 * help_all - provides a list of all available built-in shellby commands.
 */
void help_all(void)
{
...
/**
 * help_alias - provides details on the built-in command "alias" in shell by.
 */
void help_alias(void)
{
...
/**
 * help_cd - information about the built-in command "cd" in the shell.
 */
void help_cd(void)
{
